...
public class Room  {
    ...
    private ArrayList<task1.Unit> roomUnits;
     ...
     */
    public void assignUnitToRoom(task1.Unit unit){
     ...
     * @throws  IllegalArgumentException in case when Unit Object is Null
     */
    public void deleteUnit(task1.Unit unit){
        if (unit==null) throw new IllegalArgumentException("Unit can't be null");
     ...
     */
    public ArrayList<task1.Unit> getRoomUnits(){
        return roomUnits;
    }
     ...
     */
    private boolean checkExistsUnit(task1.Unit unit){
        for (task1.Unit un : roomUnits) {
